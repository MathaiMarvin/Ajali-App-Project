...
ActiveRecord::Schema[7.0].define(version: 2023_04_20_034326) do
  ...
  create_table "incidents", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_incidents_on_email", unique: true
    t.index ["reset_password_token"], name: "index_incidents_on_reset_password_token", unique: true
